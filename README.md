# ModusToolbox™ PSOC™ Control C3M8 Template Library

## Overview

mtb-template-psc3m8 provides BSP template files for the BSP Assistant tool. mtb-template-psc3m8 contains files for the PSOC Control C3M8 family
