...
#ifndef _PSC3P8GFS3PAFQ1_H_
#define _PSC3P8GFS3PAFQ1_H_

/**
* \addtogroup group_device PSC3P8GFS3PAFQ1
* \{
*/
...
typedef enum {
  ...
  /* PSC3P8GFS3PAFQ1 Peripheral Interrupt Numbers */
...
#define CY_DEVICE_SERIES_PSC3P8
#define CY_DEVICE_IFX_SECURITY_EPC3
#define CY_SILICON_ID                   0xEE871119UL
