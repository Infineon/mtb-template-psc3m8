...
#ifndef _PSC3P7GES3PAFQ1_H_
#define _PSC3P7GES3PAFQ1_H_

/**
* \addtogroup group_device PSC3P7GES3PAFQ1
* \{
*/
...
typedef enum {
  ...
  /* PSC3P7GES3PAFQ1 Peripheral Interrupt Numbers */
...
#define CY_DEVICE_SERIES_PSC3P7
#define CY_DEVICE_IFX_SECURITY_EPC3
#define CY_SILICON_ID                   0xEE881119UL
