...
* \version 1.1
*
* \brief Common startup header file for PSC devices. This file provides
...
#define PPCA_CPUSS_CNFG_CM33_GRP_NUM0_PPCA_MXCM33_SYSTEM_INT_NR 64U /* this is hidden macro in psc3_p8_config.h will check if this can be made available */
#define VECTORTABLE_SIZE        (PPCA_CPUSS_CNFG_CM33_GRP_NUM0_PPCA_MXCM33_SYSTEM_INT_NR + CM33_FIXED_EXP_NR + 1u) /* +1 is for Stack pointer */
#else
...
extern const cy_israddress_cat1b __Vectors[VECTORTABLE_SIZE];
