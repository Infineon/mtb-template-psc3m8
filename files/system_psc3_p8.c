...
/* HF clock source for PPCA cores */
#define CY_SYSCLK_CLK_PPCA_CORE_HF_PATH_NUM     (3U)

/** Default HFClk frequency in Hz */
#define CY_CLK_HFCLK0_FREQ_HZ_DEFAULT       (CY_CFG_SYSCLK_CLKHF3_FREQ)

/** Default PeriClk frequency in Hz */
#define CY_CLK_PERICLK_FREQ_HZ_DEFAULT      (CY_CFG_SYSCLK_CLKHF3_FREQ)

/** Default system core frequency in Hz */
#define CY_CLK_SYSTEM_FREQ_HZ_DEFAULT       (CY_CFG_SYSCLK_CLKHF3_FREQ)

#else /* defined(CY_PDL_PPCA_BOOT) */
/** Default HFClk frequency in Hz */
#define CY_CLK_HFCLK0_FREQ_HZ_DEFAULT       (CY_CFG_SYSCLK_CLKHF0_FREQ)

/** Default PeriClk frequency in Hz */
#define CY_CLK_PERICLK_FREQ_HZ_DEFAULT      (CY_CFG_SYSCLK_CLKHF0_FREQ)

/** Default system core frequency in Hz */
#define CY_CLK_SYSTEM_FREQ_HZ_DEFAULT       (CY_CFG_SYSCLK_CLKHF0_FREQ)
#endif /* defined(CY_PDL_PPCA_BOOT)*/
...
/*******************************************************************************
* Function Name: SystemInit_Continue_Warmboot_CAT1B_CM33
****************************************************************************//**
*
...
*
*******************************************************************************/
static void SystemInit_Continue_Warmboot_CAT1B_CM33(void)
{
    ...
    #endif /* defined(CY_PDL_TZ_ENABLED) && !defined(CY_PDL_PPCA_BOOT) */
    #if !defined(CY_PDL_PPCA_BOOT)
...
void SystemInit(void)
{
...
#endif /* CY_PDL_TZ_ENABLED !defined(CY_PDL_PPCA_BOOT) */
    ...
    /* EXTEXCLALL - enable global exclusive monitor on AHB so that atomic operation
     * on shared memory can work across main core and PPCA cores */
    SCnSCB->ACTLR |= (1UL << 29);
}
...
#else
    /* Get frequency for the PPCA high-frequency clock # 3 */
    clkHfPath = CY_SYSCLK_CLK_PPCA_CORE_HF_PATH_NUM;
#endif
